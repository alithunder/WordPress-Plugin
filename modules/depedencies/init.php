...
if (class_exists('aiowaffDashboard') != true) {
    class aiowaffDashboard
    {
        ...
        */
        ...
        /*
        * Required __construct() function that initalizes the  Framework
        */
        ...
        { 
			...
			$this->addBox( 'products_performances', 'Top 
				<select class="aiowaff-numer-items-in-top">
			...
			$this->addBox( 'aateam_products', 'Other products by Ali:', $this->aateam_products(), array(
				'size' => 'grid_4'
			) );
			
			$this->addBox( 'support', 'Need Ali Support?', $this->support() );
        }
	    ...
	    */
		...
		public function website_preview()
		{
			...
			$html[] = 	'<h4><b style="color:#a46497;">WOO Commerce All In One Affiliates - Wordpress Plugin</b> is a product that allows you to import products in your WOOCommerce store in no time!</h4>';
			$html[] = 	'<p>One time setup in just couple of minutes using <b>wordpress platform</b> and import products directly from External Products Provider in just a flash!</p>';
