<?php
/*
* Define class aiowaffSetupBackup
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
if (class_exists('aiowaffSetupBackup') != true) {
    class aiowaffSetupBackup
    {
        /*
	    ...
	    * Singleton pattern
	    *
	    * @return aiowaffSEOImages Singleton instance
	    */
...
// Initialize the aiowaffSetupBackup class
$aiowaffSetupBackup = aiowaffSetupBackup::getInstance();