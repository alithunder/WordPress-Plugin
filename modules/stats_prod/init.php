<?php
/*
* Define class aiowaffStatsProd
* Make sure you skip down to the end of this file, as there are a few
* lines of code that are very important.
*/
!defined('ABSPATH') and exit;
      
if (class_exists('aiowaffStatsProd') != true) {
    class aiowaffStatsProd
    {
        /*
	    ...
	    * Singleton pattern
	    *
	    * @return aiowaffStatsProd Singleton instance
	    */
...
// Initialize the aiowaffStatsProd class
$aiowaffStatsProd = aiowaffStatsProd::getInstance();
