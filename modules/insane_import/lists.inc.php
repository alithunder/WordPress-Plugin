...
//=======================================================
// :: Search Params
$aiowaff_search_params = array();

// AMAZON
// MinimumPrice & MaximumPrice
$aiowaff_search_params['MinimumPrice'] = array(
	"" 	        => "None",
	"100"		=> "£1.00",
	"200"		=> "£2.00",
	"500"		=> "£5.00",
...
$aiowaff_search_params['MaximumPrice'] = $aiowaff_search_params['MinimumPrice'];

// Condition
$aiowaff_search_params['Condition'] = array(
	"" 				=> "All Conditions",
	"New" 			=> "New",
	"Used" 			=> "Used",
...
// MinPercentageOff
$aiowaff_search_params['MinPercentageOff'] = array(
...
// Sort
$aiowaff_search_params['Sort'] = array();
$aiowaff_search_params['Sort']['relevancerank'] = 'Relevance rank.';
$aiowaff_search_params['Sort']['salesrank'] = "Best selling";
$aiowaff_search_params['Sort']['pricerank'] = "Price: low to high";
$aiowaff_search_params['Sort']['inverseprice'] = "Price: high to low";
$aiowaff_search_params['Sort']['launch-date'] = "Newest arrivals: low to high";
$aiowaff_search_params['Sort']['-launch-date'] = "Newest arrivals: high to low";
$aiowaff_search_params['Sort']['sale-flag'] = "On sale";
$aiowaff_search_params['Sort']['pmrank'] = "Featured items";
$aiowaff_search_params['Sort']['price'] = "Price: low to high";
$aiowaff_search_params['Sort']['-price'] = "Price: high to low";
$aiowaff_search_params['Sort']['reviewrank'] = "Average customer review: high to low";
$aiowaff_search_params['Sort']['titlerank'] = "Alphabetical: A to Z";
$aiowaff_search_params['Sort']['-titlerank'] = "Alphabetical: Z to A";
$aiowaff_search_params['Sort']['pricerank'] = "Price: low to high";
$aiowaff_search_params['Sort']['inverse-pricerank'] = "Price: high to low";
$aiowaff_search_params['Sort']['daterank'] = "Publication date: newer to older";
$aiowaff_search_params['Sort']['psrank'] = "Bestseller ranking - projected sales.";
$aiowaff_search_params['Sort']['orig-rel-date'] = "Release date: newer to older";
$aiowaff_search_params['Sort']['-orig-rel-date'] = "Release date: older to newer";
$aiowaff_search_params['Sort']['releasedate'] = "Release date: newer to older";
$aiowaff_search_params['Sort']['-releasedate'] = "Release date: older to newer";
$aiowaff_search_params['Sort']['songtitlerank'] = "Most popular";
$aiowaff_search_params['Sort']['uploaddaterank'] = "Date added";
$aiowaff_search_params['Sort']['-video-release-date'] = "Release date: newer to older";
$aiowaff_search_params['Sort']['-edition-sales-velocity'] = "Quickest to slowest selling products.";
$aiowaff_search_params['Sort']['subslot-salesrank'] = "Bestselling";
$aiowaff_search_params['Sort']['release-date'] = "Latest release date: from newer to older.";
$aiowaff_search_params['Sort']['-age-min'] = "Age: high to low";

$__tmp = $aiowaff_search_params;
$aiowaff_search_params = array();
$aiowaff_search_params['amazon'] = $__tmp;
...
*/
//ListingType
$aiowaff_search_params['ebay'] = array_merge(array(
	'sortOrder' 			=> array(
...
//=======================================================
// :: Params description
$aiowaff_search_params_desc = array();
$aiowaff_search_params_sort = array();
$aiowaff_search_params_sel = array();

// AMAZON
$aiowaff_search_params_sort['amazon'] = $aiowaff_search_params['amazon']['Sort'];
$aiowaff_search_params_sort['amazon']["relevancerank"] = 'Items ranked according to the following criteria: how often the keyword appears in the description, where the keyword appears (for example, the ranking is higher when keywords are found in titles), how closely they occur in descriptions (if there are multiple keywords), and how often customers purchased the products they found using the keyword.';
$aiowaff_search_params_sort['amazon']["psrank"] = 'Bestseller ranking taking into consideration projected sales. The lower the value, the better the sales.';
$aiowaff_search_params_sort['amazon']["release-date"] = 'Sorts by the latest release date from newer to older. See orig-rel-date, which sorts by the original release date.';

$aiowaff_search_params_desc['amazon'] = array(
...
// ENVATO
$aiowaff_search_params_desc['envato'] = array_merge(array(
	'term' 	 				 => 'The string to search for',
	'site' 	 				 => 'The site to match.',
	'tags' 	 				 => 'Comma separated list of tags to match',
	'category' 			 	 => 'Category code to search for',
	'platform' 			 	 => 'The platform to match',
	'compatible_with' 		 => 'Frameworks or compatible software to match',
	'colors' 			 	 => 'Comma separated list of colors to match',
	'size' 	 				 => 'A minimum photo size to match',
	'sales' 			 	 => 'Name of the sales bucket to filter by (see the aggregation sales result)',
	'rating_min' 			 => 'Minimum rating to filter by',
	'price_min' 			 => 'Minimum price to include',
	'price_max' 			 => 'Maximum price to include',
	'poly_count' 			 => 'Prefered polygon count. Either a single polygon count or a range seperated by -',
	'item_type' 			 => 'The item type to match',
	'suggest' 			 	 => 'Whether to include search suggestions',
	'date' 	 				 => 'Restrict items by original uploaded date',
	'length_min' 			 => 'Minimum video or audio length in the form: 0:00',
	'length_max' 			 => 'Maximum video or audio length in the form: 0:00',
	'tempo' 			 	 => 'One of very-slow, slow, medium, upbeat, fast and very-fast',
	'alpha' 			 	 => 'Does the graphic include an alpha mask',
	'vocals_in_audio' 		 => 'The type of vocal content in audio files',
	'looped' 			 	 => 'Does the item loop seamlessly',
	'orientation' 			 => 'Image or video orientation to match',
	'requires_plugins' 		 => 'Restrict to items that do or don\'t require plugins',
	'resolution_min' 		 => 'The minimum resolution for video content',
	'frame_rate' 			 => 'Match a particular FPS value for video content',
	'String' 			 	 => 'Match a particular FPS value for video content',
	'page' 	 				 => 'Page number (max. 60)',
	'page_size' 			 => 'Number of items per page (max. 100)',
	'username' 			 	 => 'Username to restrict by',
	'sort_by' 			 	 => 'Sort by one of the following: relevance, rating, sales, price, date, updated, category, name, trending',
	'sort_direction' 		 => 'Sort direction. One of: asc, desc',
));

// EBAY
$aiowaff_search_params_sel['ebay']['sortOrder'] = array_merge(array(
...
$aiowaff_search_params_sel['ebay']['Condition'] = array_merge(array(
...
$aiowaff_search_params_sel['ebay']['Currency'] = array_merge(array(
...
$aiowaff_search_params_sel['ebay']['ListingType'] = array_merge(array(
...
$aiowaff_search_params_sel['ebay']['PaymentMethod'] = array_merge(array(
...
$aiowaff_search_params_desc['ebay'] = array_merge(array(
