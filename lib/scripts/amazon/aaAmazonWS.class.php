...
class aaAmazonWS
{
	 ...
	 * @var array
	 */
	private $possibleLocations = array('de', 'com', 'co.uk', 'ca', 'fr', 'co.jp', 'it', 'cn', 'es', 'in', 'com.mx', 'com.br');
	...
	protected function performXMLRequest($function, $params)
	{
		...
		//var_dump('<pre>', $sign_params, $this->xmlAmazonLink, $ret_, $ret, '</pre>'); die('debug...'); 
