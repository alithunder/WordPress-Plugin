...
if ( !defined('ABSPATH') ) {
	...
	die('wrong path!');
		...
		function getAmazonCategs( $req_aff_id=null )
		{
			...
			$csv_file_content = $adf->wp_filesystem->get_contents( $adf->cfg['paths']['plugin_dir_path'] . 'assets/amazon/browsenodes.csv' );
...
$categs = $adf->amzHelper->getAmazonCategs();
var_dump('<pre>', $categs, '</pre>');
getAmazonCategs();
die('debug...');
